...
import libvisor.persistence.Server_Manager_UI as ManagerUI
from libvisor.persistence.AddServerWindowManager import AddServerWindowManager as addServerManager
from libvisor.persistence.ThreddsServerInfo import ThreddsServerInfoObject, isValidName, isValidURL
...
class ServerStorageManager(QDialog):
    ...
    *** With proper configuration, this can be used to send
    ...
    def _onbuttonLoadDataClick(self):
        ...
        print len(self.availableServers)
    ...
    def _onAttemptToAddNewServer(self, inServerDetails):
        ...
        if not isValidName(inServerDetails[0]):
            ...
            print type(inServerDetails[0])
            serverInfo = ThreddsServerInfoObject(str(inServerDetails[0]), str(inServerDetails[1]))
            print ' type :: '
